...
exports.autorPorId = function(aut){
	GralAutor = aut;
	console.log(GralAutor);
};

exports.create = function(req, res) {
	var articulo = new Articulo(req.body);
	Autor.findById(req.body.autor_id).populate('autor', 'name').exec(function(err, autor) {
		exports.autorPorId(autor);
	});
	console.log(GralAutor);
	articulo.autor = GralAutor;
